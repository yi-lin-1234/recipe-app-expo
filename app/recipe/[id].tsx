...
import { RecipeWithUserInfo } from "../../type";
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.stats}>
          <View style={styles.statsItem}>
            <Feather color="#7B7C7E" name="map-pin" size={15} />
            <Text style={styles.statsItemText}>Cuisine: {recipe.cuisine}</Text>
          </View>
        </View>

        <View style={styles.stats}>
          <View style={styles.statsItem}>
            <Entypo color="#7B7C7E" name="bar-graph" size={15} />
        ...
        <View style={styles.stats}>
          <View style={styles.statsItem}>
            <Feather color="#7B7C7E" name="clock" size={15} />
            <Text style={styles.statsItemText}>
              Total Time: {recipe.totalPrepTime} mins
            </Text>
          </View>
        </View>

        <View style={styles.about}>
          <Text style={styles.aboutTitle}>Ingredients</Text>
          <Text style={styles.aboutDescription}>{recipe.ingredients}</Text>
          <Text style={styles.aboutTitle}>Instructions</Text>
          <Text style={styles.aboutDescription}>{recipe.instructions}</Text>
          <Text style={styles.aboutTitle}>Notes</Text>
          <Text style={styles.aboutDescription}>{recipe.notes}</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
